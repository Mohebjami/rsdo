                  ...
                  child: Container(
                    ...
                    child: ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        final totalStream =
                        FirebaseFirestore.instance.collection('Paid').where('Store Name', isEqualTo: user).snapshots();
                        final femaleStream =
                        FirebaseFirestore.instance
                            .collection('Paid').where('Store Name',
                            isEqualTo: user).where('Recipient Gender', isEqualTo: 'Female')
                            .snapshots();
                        final maleStream = FirebaseFirestore
                            .instance
                            .collection('Paid').where('Store Name',
                            isEqualTo: user).where('Recipient Gender',
                            isEqualTo: 'Male').snapshots();
                                  ...
                                  children: [
                                    ...
                                    StreamBuilder<QuerySnapshot>(
                                      ...
                                      builder:
                                        ...
                                        return Text(
                                          '$total',style: const TextStyle(fontSize: 20),);
                                      },
                                    ),
                                    const Text("Total"),
                                  ],
                                  ...
                                  children: [
                                    ...
                                    StreamBuilder<QuerySnapshot>(
                                      ...
                                      builder:
                                        ...
                                        final female = snapshot
                                            .data?.docs.length;

                                        return Text(
                                          '$female',style: const TextStyle(fontSize: 20),);
                                      },
                                    ),
                                    const Text("Female"),
                                  ],
                                  ...
                                  children: [
                                    ...
                                    StreamBuilder<QuerySnapshot>(
                                      ...
                                      builder:
                                        ...
                                        return Text('$male',style: const TextStyle(fontSize: 20),);
                                      },
                                    ),
                                    const Text("Male"),
                                  ],
