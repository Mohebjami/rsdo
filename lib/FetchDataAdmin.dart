                  ...
                  child: Padding(
                    ...
                    child: DropdownButton<String>(
                      ...
                      style: const TextStyle(
                          ...
                          fontWeight: FontWeight.bold), // Change color here
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  colorFilter: ColorFilter.mode(
                    Colors.orangeAccent
                        .withOpacity(0.6), // this is a common warning color
                    BlendMode.srcOver,
                  ),
                )),
                child: const Column(
              ...
              Container(
                ...
                child: Column(
                  children: [
                    ...
                    const Text('Beneficiaries were paid.',
                        style:
                            TextStyle(fontSize: 20, fontFamily: "LilitaOne")),
                    const SizedBox(height: 20),
                    SizedBox(
                      width: 220,
                      child: ElevatedButton(
                        ...
                        child: const Text('CONTINUE',
                            style: TextStyle(
                                color: Colors.white, fontFamily: "LilitaOne")),
                      ),
                    ),
                    const SizedBox(
                      height: 30,
